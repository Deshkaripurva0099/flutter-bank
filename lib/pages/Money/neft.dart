...
class NEFTFormPage extends StatefulWidget {
  const NEFTFormPage({super.key});

  @override
  State<NEFTFormPage> createState() => _NEFTFormPageState();
}

class _NEFTFormPageState extends State<NEFTFormPage> {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          title: const Text("NEFT Initiated"),
          content: Text(
                  ...
                  children: [
                          ...
                          child: TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.trim().isEmpty) {
                                ...
                                return "Invalid IFSC format (e.g., HDFC0AAAA12)";
                              }
                              return null;
                            },
                          ),
                    ...
                    if (_submitted)
                      Container(
                        ...
                        child: const Text(
                          "✅ NEFT Transfer submitted successfully!",
