...
class ClientCard2 extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> transactions = [
    ...
    {'id': 3, 'merchant': "Netflix", 'card': "Credit Card ****9012", 'amount': -499, 'date': "2025-01-08"},
    {'id': 4, 'merchant': "Zomato", 'card': "Debit Card ****5678", 'amount': -350, 'date': "2025-01-07"},
  ];

  final List<Map<String, dynamic>> summaryCards = [
    {'title': 'Cashback Earned', 'value': '₹2,450', 'subtitle': 'This month', 'color': Colors.green},
    {'title': 'Reward Points', 'value': '15,680', 'subtitle': 'Available to redeem', 'color': Colors.orange},
    {'title': 'Monthly Spend', 'value': '₹18,750', 'subtitle': 'Across all cards', 'color': Colors.red},
    {'title': 'EMI Spends', 'value': '₹12,400', 'subtitle': 'Active EMIs', 'color': Colors.blue},
    {'title': 'Pending Dues', 'value': '₹3,200', 'subtitle': 'Due in 5 days', 'color': Colors.purple},
    {'title': 'Total Cards', 'value': '3', 'subtitle': 'Active accounts', 'color': Colors.teal},
  ];
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Common card management tasks', style: TextStyle(fontSize: 14, color: Colors.grey[600])),
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final icon = action['icon'] is IconData ? action['icon'] as IconData : Icons.help_outline;
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 5),
          Text('Latest transactions across all cards', style: TextStyle(fontSize: 14, color: Colors.grey[600])),
          const SizedBox(height: 15),
          Column(children: transactions.map((txn) => _buildTransactionRow(txn)).toList()),
        ]),
      ),
    );
  }
  ...
  Widget _buildTransactionRow(Map<String, dynamic> txn) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(merchant, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            Text(card, style: TextStyle(fontSize: 12, color: Colors.grey[600])),
          ]),
        ),
