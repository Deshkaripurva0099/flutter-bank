...
import 'video_kyc_form.dart';

class PanVerificationForm extends StatefulWidget {
  const PanVerificationForm({super.key});

  @override
  State<PanVerificationForm> createState() => _PanVerificationFormState();
}

class _PanVerificationFormState extends State<PanVerificationForm> {
  final TextEditingController _panController = TextEditingController();
  final TextEditingController _otpController = TextEditingController();
  bool _otpSent = false;

  bool _isPanValid() {
    return _panController.text.trim().length == 10;
  }
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildConnector(true), // Active for step 1-2-3
                        _buildStepIndicator(2, "Aadhar", false),
                        _buildConnector(true), // Active for step 2-3
                        _buildStepIndicator(3, "PAN", true),
                        ...
                        onPressed: _otpSent && _isOtpValid()
                            ? () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => const VideoKycForm(),
                                  ),
                                );
                              }
                            : null,
