...
import 'clientpersonaldetails.dart'; 
...
class _MyAccountsPageState extends State<MyAccountsPage> {
  ...
  child: const Text("Close"),
                      ...
                      ElevatedButton.icon(
                        ...
                        label: const Text("Download Statement", style: TextStyle(color: Colors.white)),
          ...
          PopupMenuButton<int>(
            ...
            icon: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white.withValues(alpha: 0.1), // ✅ FIXED: Using withValues
...
class _MyAccountsPageState extends State<MyAccountsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: _customDrawer(), // ✅ DRAWER ADD KELA
      backgroundColor: const Color.fromARGB(255, 248, 248, 248),
      appBar: AppBar(
        backgroundColor: primaryRed,
        toolbarHeight: 75,
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            leading: const Icon(Icons.attach_money, color: Color(0xFF900603)),
